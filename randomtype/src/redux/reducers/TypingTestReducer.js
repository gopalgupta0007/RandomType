    ...
    switch (action.type) {
        ...
        case "ADD_WPM":
            return {
                ...
                typing_data: {
                    ...state.typing_data,
                    total_wpm: [...state.typing_data.total_wpm, action.payload]
                }
            }
        case "ADD_ACCURACY":
            return {
                ...
                typing_data: {
                    ...state.typing_data,
                    total_accuracy: [...state.typing_data.total_accuracy, action.payload]
                }
            }
        case "NO_OF_COUNT":
            return {
                ...
                typing_data: {
                    ...state.typing_data,
                    no_of_test: [...state.typing_data.no_of_test, action.payload]
                }
            }
