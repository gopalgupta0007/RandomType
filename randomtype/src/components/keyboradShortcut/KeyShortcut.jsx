            ...
            <Container maxWidth="xl">
                <Box className="bg-white m-10 rounded-lg">
                    ...
                    <div id="listOfKeys" className="mx-5">
                        <div className="p-1 flex justify-between border-gray-300 hover:bg-slate-100">
                            <h1>Restart Typing Test</h1>
                            <div className='flex'>
                                <kbd>Shift</kbd>+<kbd>Enter</kbd>
                            </div>
                        </div>
                        <div className="p-1 flex justify-between border-t-2 border-gray-300 hover:bg-slate-100">
                            <h1>Reload Page</h1>
                            <div className='flex'>
