...
const NavGameProgressBar = ({ Letter, placeholderText, CountDownTimer, setCountDownTimer, IncorrectLetter }) => {
    ...
    return (
        <div id='display-progress' className='w-4/5 m-auto flex justify-center items-center text-[2vw] font-extrabold'>
            ...
            <div id='StrengerData' className='flex flex-col gap-x-14 bg-red-500 text-white px-5 py-3 rounded-tr-xl rounded-br-xl'>
                <div>
                    <h1 className='text-center text-red-950 text-2xl'>Strenger</h1>
                </div>
                <div className='flex gap-x-12 bg-red-500 text-white px-5 rounded-tl-xl rounded-bl-xl'>
